...
#FILL IN THE ID'S IF YOU WANT TO USE IT FOR YOUR OWN DISCORD SERVER

INPUT_CHANNEL_ID = "XXXXXXXXXXXXXXXXXXXXXXXXX"
OUTPUT_CHANNEL_ID = "XXXXXXXXXXXXXXXXXXXXXXXXX"
